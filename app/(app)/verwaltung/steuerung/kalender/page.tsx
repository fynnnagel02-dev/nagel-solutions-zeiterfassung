    ...
    <div className="space-y-6">
      ...
      <Panel>
        <form className="grid gap-4 md:grid-cols-3">
          <input name="year" type="number" defaultValue={calendar.year} className="rounded-2xl border border-[color:var(--color-border-strong)] bg-[color:var(--color-panel-soft)] px-4 py-3 text-sm" />
          <select name="month" defaultValue={String(calendar.month)} className="rounded-2xl border border-[color:var(--color-border-strong)] bg-[color:var(--color-panel-soft)] px-4 py-3 text-sm">
          ...
          <select name="teamId" defaultValue={params.teamId ?? ""} className="rounded-2xl border border-[color:var(--color-border-strong)] bg-[color:var(--color-panel-soft)] px-4 py-3 text-sm">
