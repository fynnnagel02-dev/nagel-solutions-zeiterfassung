          ...
          <div className="space-y-5 bg-[linear-gradient(180deg,rgba(17,32,57,0.98),rgba(23,40,69,0.98))] px-6 py-7 text-white">
            <div className="space-y-2">
              ...
              <p className="max-w-2xl text-sm leading-6 text-slate-200/90">
                {today}. Diese Fläche bündelt offene Entscheidungen, Teamstatus und die nächsten sinnvollen Wege in die Stammdaten oder operative Steuerung.
              </p>
            </div>
            ...
            <div className="grid gap-3 md:grid-cols-3">
              <Link href="/verwaltung/steuerung/freigaben" className="rounded-[1.2rem] border border-white/10 bg-black/10 px-4 py-3 text-sm font-semibold text-white">
                Zu Freigaben
              </Link>
              <Link href="/verwaltung/steuerung/kalender" className="rounded-[1.2rem] border border-white/10 bg-black/10 px-4 py-3 text-sm font-semibold text-white">
                Zum Kalender
              </Link>
              <Link href="/verwaltung/einstellungen" className="rounded-[1.2rem] border border-white/10 bg-black/10 px-4 py-3 text-sm font-semibold text-white">
                Zu Einstellungen
              </Link>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="rounded-[1.5rem] border border-[color:var(--color-border-soft)] bg-[color:var(--color-panel-soft)] p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <StatusChip label={`${summary.pendingTimeEntries}`} tone={summary.pendingTimeEntries > 0 ? "warning" : "success"} />
                </div>
              ...
              <div className="rounded-[1.5rem] border border-[color:var(--color-border-soft)] bg-[color:var(--color-panel-soft)] p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <StatusChip label={`${summary.pendingLeaveRequests}`} tone={summary.pendingLeaveRequests > 0 ? "warning" : "success"} />
                </div>
                <p className="mt-2 text-sm text-[color:var(--color-text-soft)]">
